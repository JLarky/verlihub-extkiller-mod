...
function VH_OnUserLogin(nick)
	...
	msg=string.format("ѕривет, %s! Ќе забудь поставить новые заплатки на винду, дабы не отключили от сети. Ќа вики написаны подробности http://wiki.punklan.net/news:2009-01-22_conficker\nƒа и вообще, недавно satter подн€л сервер дл€ обновлений винды, так что если вы всЄ ещЄ пользуетесь виндами, то вам сюда http://wiki.punklan.net/lan:wsus", nick )
